...
\usepackage{wrapfig}
\graphicspath{{C:/Users/c1764397/Workshop/DataVis/Assignment2/Images/}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{Section31.png}
\end{figure}
\begin{description}
	\item[$\bullet$ Tool:] ParaView 5.50
	\item[$\bullet$ Visualisation Type:] A
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{Section32.png}
\end{figure}
\begin{description}
	\item[$\bullet$ Tool:] ParaView 5.50
	\item[$\bullet$ Visualisation Type:] A
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{Section41.png}
\end{figure}
\begin{description}
	\item[$\bullet$ Tool:] ParaView 5.50
	\item[$\bullet$ Visualisation Type:] A
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{Section42.png}
\end{figure}
\begin{description}
	\item[$\bullet$ Tool:] ParaView 5.50
	\item[$\bullet$ Visualisation Type:] A
